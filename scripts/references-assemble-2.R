...
prefixes.list <- c("12s.12S-V5", "12s.bylemans-AcMDB", "12s.bylemans-MarVer1",
                   ...
                   "16s.berry-1", "16s.bylemans", "16s.dibattista", 
...
if(opt$metabarcode == "all") {
  prefixes.all <- c("12s.12S-V5.noprimers", "12s.bylemans-AcMDB.noprimers", "12s.bylemans-MarVer1.noprimers",
                    ...
                    "16s.berry-1.noprimers", "16s.bylemans.noprimers", "16s.dibattista.noprimers", 
...
writeLines("\nWriting out first reference library to 'assets/reference-library-master1.csv.gz' ...")
write_csv(dbs.merged.final, file=gzfile(here("assets/reference-library-master.csv1.gz")), na="")
...
# write out a gzipped file (orig is too big for github)
writeLines("\nWriting out reference library to 'assets/reference-library-master2.csv.gz' ...")
write_csv(dbs.merged.final, file=gzfile(here("assets/reference-library-master2.csv.gz")), na="")
