...
prefixes.list <- c("12s.12S-V5", "12s.bylemans-AcMDB",
                   "12s.evans-Ac", "12s.evans-Am", "12s.kelly",
                   "12s.riaz", "12s.riaz-1", "16s.berry",
                   "16s.berry-1", "16s.bylemans",  
                  "16s.evans-Ve", "16s.kitano", 
...
if(opt$metabarcode == "all") {
  prefixes.all <- c("12s.12S-V5.noprimers", "12s.bylemans-AcMDB.noprimers",
                    "12s.evans-Ac.noprimers", "12s.evans-Am.noprimers", "12s.kelly.noprimers",
                     "12s.riaz.noprimers", "12s.riaz-1.noprimers", 
                    
          "16s.berry.noprimers", 
                    "16s.berry-1.noprimers", "16s.bylemans.noprimers",  
                   "16s.evans-Ve.noprimers", "16s.kitano.noprimers", 
