...
if(opt$exhaustive == "true") {
    gene.syns <- "(COI[ALL] OR 12S[ALL] OR 18S[ALL] OR RAG1[ALL] OR ND2[ALL] OR S7[GENE] OR ND5[ALL] OR Rho[GENE] OR 16S[ALL] OR rRNA[ALL] OR ribosomal[ALL] OR cytb[ALL] OR CO1[ALL] OR cox1[ALL] OR cytochrome[ALL] OR subunit[ALL] OR COB[ALL] OR CYB[ALL] OR mitochondrial[ALL] OR mitochondrion[ALL])"
